...
"""
    ...
    print("   Next steps:")
    print(f"   1. Add canonical text in data/verses/{collection}.yaml")
    print(f"      (or populate it from source with: verse-parse-source --collection {collection} --source <path-to-source-text>)")
    ...
    print("   4. Generate verse assets (scene descriptions are auto-generated by verse-generate, or edit data/scenes manually):")
    print(f"      verse-generate --collection {collection} --verse 1")
    print("   5. Run: verse-validate")
    print("   6. Continue for full collection:")
    print(f"      verse-generate --collection {collection} --verse 1-{num_verses}")
...
def init_project(
    ...
    if collections:
        print("   2. Add canonical text in data/verses/<collection>.yaml")
        print("      (or populate it from source with: verse-parse-source --collection <collection-key> --source <path-to-source-text>)")
        print("   3. Review/edit verse markdown in _verses/<collection>/")
        print("   4. Optional: customize theme in data/themes/<collection>/modern-minimalist.yml")
        print("   5. Generate first verse (scene descriptions are auto-generated by verse-generate, or edit data/scenes manually):")
        print("      verse-generate --collection <collection-key> --verse 1")
        print("   6. Run: verse-validate")
        print("   7. Continue for full collection:")
        print("      verse-generate --collection <collection-key> --verse 1-N")
        print("      # or iterative: verse-generate --collection <collection-key> --next")
        print("   8. Optional: verse-embeddings / verse-index-sources / verse-puranic-context / verse-deploy")
    else:
